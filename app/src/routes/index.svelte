			...
			{#each Benefits as {title, text}}
				<div class="relative">
					<dt>
						...
						<svg class="absolute h-6 w-6 text-cyan-900" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
							<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
						</svg>
						<p class="ml-9 text-lg leading-6 font-medium text-cyan-900">{title}</p>
					</dt>
	...
	<div class="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl">
		<div class="relative rounded-lg overflow-hidden lg:h-96">
			<div class="absolute inset-0">
				<img src="https://cdn.tze1.ru/l9/0c97d4e5-61d2-11e9-8dc3-e8611f100fce/1082122.png" alt="" class="w-full h-full object-center object-cover">
			</div>
			...
			<div class="absolute inset-x-0 bottom-0 bg-sky-800 bg-opacity-70 p-6 rounded-bl-lg rounded-br-lg backdrop-filter backdrop-blur sm:flex sm:items-center sm:justify-between lg:inset-y-0 lg:inset-x-auto lg:w-96 lg:rounded-tl-lg lg:rounded-br-none lg:flex-col lg:items-start">
				<div>
