...
<div class="bg-white">
	<div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8">
		<div class="max-w-3xl mx-auto text-center">
			<h2 class="text-4xl font-extrabold text-gray-700">Компания "Новострой"</h2>
...
<!--							<a href="#" class="w-5xl flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-indigo-600 bg-white hover:bg-gray-50 md:py-4 md:text-lg md:px-10"> Live demo </a>-->
<!--						</div>-->
<!--					</div>-->
<!--				</div>-->
<!--			</div>-->
<!--			<div class="relative w-full h-64 sm:h-72 md:h-96 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 lg:h-full">-->
<!--				<img class="absolute inset-0 w-full h-full object-cover" src="static/logo.png" alt="logo">-->
<!--			</div>-->
<!--		</main>-->
<!--	</div>-->
</div>
				...
				<div class="mt-12 relative text-base max-w-prose mx-auto lg:mt-0 lg:max-w-none">
					...
					<blockquote class="relative bg-white rounded-lg shadow-lg">
						<div class="rounded-t-lg px-6 py-8 sm:px-10 sm:pt-10 sm:pb-8">
							<img src="static/logo-header.png" alt="logo" class="h-16">
