	...
	<div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-16 lg:px-8 ">
		<div class="text-lg  max-w-prose mx-auto">
			<h1>
				...
				<span class="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">Ремонт под ключ или частичный ремонт квартиры от ремонтной компании "Новострой"</span>
			</h1>
