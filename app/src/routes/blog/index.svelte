<div class="bg-gradient-to-b from-white to-gray-50 py-16 px-4 sm:px-6 lg:py-16 lg:px-8">
    ...
    <div class="relative py-16 max-w-lg mx-auto divide-y-2 divide-gray-200 lg:max-w-7xl">
        ...
        <div>
            <h2 class="text-3xl tracking-tight font-extrabold text-gray-900 sm:text-4xl">Тематические статьи</h2>
            <div class="mt-3 sm:mt-4 lg:grid lg:grid-cols-2 lg:gap-5 lg:items-center">
                ...
                <form class="mt-6 flex flex-col sm:flex-row lg:mt-0 lg:justify-end">
                    <div>
                        ...
                        <input id="email-address" name="email-address" type="email" autocomplete="email" required class="appearance-none w-full px-4 py-2 border border-gray-300 text-base rounded-md text-gray-900 bg-white placeholder-gray-500 focus:outline-none focus:ring-sky-500 focus:border-sky-500 lg:max-w-xs" placeholder="Enter your email">
                    </div>
                    <div class="mt-2 flex-shrink-0 w-full flex rounded-md shadow-sm sm:mt-0 sm:ml-3 sm:w-auto sm:inline-flex">
                        <button type="button" class="w-full bg-sky-600 px-4 py-2 border border-transparent rounded-md flex items-center justify-center text-base font-medium text-white hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500 sm:w-auto sm:inline-flex">Notify me</button>
                    </div>
                </form>
            </div>
        </div>
        <div class="mt-6 pt-10 grid gap-16 lg:grid-cols-2 lg:gap-x-5 lg:gap-y-12">
            <div>
                ...
                <div class="mt-3">
                    <a href="#" class="text-base font-semibold text-sky-600 hover:text-sky-500"> Read full story </a>
                </div>
            </div>
